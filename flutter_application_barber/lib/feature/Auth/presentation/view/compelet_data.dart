...
class CompeletData extends StatefulWidget {
  const CompeletData({super.key});

  @override
  _CompeletDataState createState() => _CompeletDataState();
}

class _CompeletDataState extends State<CompeletData> {
  ...
  Future<String> uploadImageToFireStore(File image) async {
    ...
    var ref = _storage.ref().child('Owner/${_auth.currentUser!.uid}');
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                            hintText:
                                'سجل المعلومات  العامة مثل اعمالك وخبراتك السابقة...',
            ...
            child: ElevatedButton(
              onPressed: () async {
                if (_formKey.currentState!.validate()) {
                  context.read<AuthCubit>().UploadOnwerData(OnwerModel(
                      id: user!.uid,
